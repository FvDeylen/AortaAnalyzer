...
class CenterlineModule(QWidget):
    """
    ...
    def __init__(self, parent=None):
        ...
        self.modelOpacity = 0.4
        self.opacity_slider.setValue(int(self.modelOpacity*100))
        self.opacity_slider_label = QLabel("Surface Opacity")
        ...
        self.opacity_slider.valueChanged[int].connect(self.opacityChanged)
        ...
        self.text_patient.SetInput("No segmentation file found.")
        ...
        self.button_layout.addWidget(self.opacity_slider_label)
        self.button_layout.addWidget(self.opacity_slider)
        ...
        self.actor_lumen.GetProperty().SetOpacity(self.modelOpacity)  # 
    ...
    def loadPatient(self, patient_dict):
        ...
        lumen_file, centerline_file = patient_dict["model"], patient_dict["centerlines"]
        self.DelaunayTessellation = None
        self.VoronoiDiagram = None
        self.PoleIds = None
        self.SourceId = None
    ...
    def opacityChanged(self,threshold):
        # change opacity of lumen surface
        self.modelOpacity = threshold/100
        if self.actor_lumen:
            self.actor_lumen.GetProperty().SetOpacity(self.modelOpacity)
        self.centerline_view.GetRenderWindow().Render()
    ...
    def getSeedsFromCenterlines(self):
        # get inlet and outlets from given centerline
    ...
    def save(self):
        ...
        path = os.path.join(base_path, "models", patient_ID + ".vtp") 
